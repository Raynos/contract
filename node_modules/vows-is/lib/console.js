// copied verbatim from vows/lib/vows/console.js
var eyes = require('eyes').inspector({ stream: null, styles: false });

// Stylize a string
exports.stylize = function stylize(str, style) {
    var styles = {
        'bold'      : [1,  22],
        'italic'    : [3,  23],
        'underline' : [4,  24],
...
exports.contextText = function (event) {
    return '  ' + event;
};

exports.vowText = function (event) {
    var buffer = [];
